        ...
        <div className="glowing-card bg-white shadow-md rounded-lg p-8 w-full max-w-md">
          ...
          <div className="flex justify-center mt-8">
            <button
              ...
              disabled={loading}
              className={`relative inline-flex items-center justify-start py-4 pl-6 pr-16 overflow-hidden font-semibold text-indigo-600 transition-all duration-150 ease-in-out rounded hover:pl-12 hover:pr-10 bg-gray-50 border-1 group ${
